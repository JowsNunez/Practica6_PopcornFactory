...
class CatalogActivity : AppCompatActivity() {
    ...
    var serie_adapter: PeliculaAdapter? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        serie_adapter = PeliculaAdapter(this, series)
        ...
        gridSeries.adapter=serie_adapter
    }
        ...
        series.add(
            Pelicula(
                ...
                "Dr. Temperance Brennan is a brilliant, but lonely, anthropologist whom is approached by an " +
                        ...
                        "and Dr. Brennan and her team come up again a variety of interference from red tape, corruption,s" +
